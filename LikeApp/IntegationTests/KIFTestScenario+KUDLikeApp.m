...
+ (id)scenarioToLogIn;
{
    ...
    [scenario addStep:[KIFTestStep stepToEnterText:@"lmn.huy@gmail.com" intoViewWithAccessibilityLabel:@"email"]];
...
+ (id)scenarioToMyPage;
{
    ...
    [scenario addStep:[KIFTestStep stepToWaitForTappableViewWithAccessibilityLabel:@"BiBi"]];
    ...
    // quay ve mypage 
    [scenario addStep:[KIFTestStep stepToTapViewWithAccessibilityLabel:@"BiBi"]];
...
+ (id)scenarioToNavigation{
    KIFTestScenario *scenario = [KIFTestScenario scenarioWithDescription:@"Test that a user can successfully CreateAccount."];
    [scenario addStep:[KIFTestStep stepToReset]];
    [scenario addStepsFromArray:[KIFTestStep stepsGoToLogin]];
    [scenario addStepsFromArray:[KIFTestStep stepsGoToNavigation]];
    return scenario;
}
@end
