...
+ (NSArray *)stepsGoToSetting{
    ...
    // write full name 
    [steps addObject:[KIFTestStep stepToEnterText:@"GameK" intoViewWithAccessibilityLabel:@"fullname"]];
    [steps addObject:[KIFTestStep stepToWaitForTimeInterval:2.0 description:@"wait 2.0"]];
...
+ (NSArray *)stepsGoToLogin{
     NSMutableArray *steps = [NSMutableArray array];
    [steps addObject:[KIFTestStep stepToEnterText:@"login@mulodo.com" intoViewWithAccessibilityLabel:@"email"]];
